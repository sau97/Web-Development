...
<div class="topnav">
  ...
  <a class="active" href="dell.php">Dell</a>
  <a href="aboutus.php">AboutUs</a>
  <a href="insert.php">ContactUs</a>
  <a href="registartion.php">SIGNUP</a>
  
</div>

<h1 style="text-align:center">DELL Inspiron</h1>

<img src="dell.jpeg"  style="width:550px; height:350px;">
...
<div class="columns">
  <ul class="price">
    ...
    <li class="grey">Dell Inspiron Notebook</li>
    <li>15.50 inches</li>
    <li>6th</li>
    <li>4 GB</li>
    <li>1 TB</li>
