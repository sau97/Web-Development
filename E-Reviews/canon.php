...
<div class="topnav">
  ...
  <a class="active" href="canon.php">Canon</a>
  <a href="aboutus.php">AboutUs</a>
  <a href="insert.php">ContactUs</a>
  <a href="registration.php">SIGNUP</a> 
</div>

<h1 style="text-align:center">CANON EOS700</h1>

<img src="eos700.jpg"  style="width:550px; height:350px;">
...
<div class="columns">
  <ul class="price">
    ...
    <li class="grey">Canon EOS 700D</li>
    <li>18MP</li>
    <li>YES</li>
    <li>1920 x 1080</li>
    <li>1/4000 s</li>
